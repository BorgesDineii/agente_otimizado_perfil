...
Clone o Repositório:
Bashtextgit clone https://github.com/SeuUsuario/NomeDoSeuRepositorio.git
...
Bash
textpip install streamlit google-genai
...
Windows (CMD):
Bashtextset GEMINI_API_KEY="SUA_CHAVE_AQUI"
macOS/Linux:
Bashtextexport GEMINI_API_KEY="SUA_CHAVE_AQUI"
...
Bash
textpython -m streamlit run app.py
